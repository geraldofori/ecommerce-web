                        ...
                        <>
                            <div className="w-full lg:w-2/3 p-6 lg:p-10 bg-pureWhite rounded-lg">
                                ...
                                <Form id="checkout-form">
                                    ...
                                    <div className="w-full bg-pureWhite rounded-lg h-fit mt-8 lg:hidden">
                                        ...
                                        {cart.length === 0 ? (
                                            ...
                                            <>
                                                ...
                                                <button
                                                    type="submit"
                                                    className="w-full bg-darkOrange hover:bg-fadedOrange duration-300 text-pureWhite py-3 uppercase font-bold disabled:opacity-50 cursor-pointer"
                                ...
                                {cart.length === 0 ? (
                                    ...
                                    <>
                                        ...
                                        <button
                                            type="submit"
                                            form="checkout-form"
                                            className="w-full bg-darkOrange hover:bg-fadedOrange duration-300 text-pureWhite py-3 uppercase font-bold cursor-pointer disabled:opacity-50"
                                            disabled={!isValid || !dirty || cart.length === 0}
                                        >
                                            Continue & Pay
                                        </button>
